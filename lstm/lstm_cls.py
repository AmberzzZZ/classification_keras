...
def lstm_model(input_shape=(28,28)):
    model = Sequential()
...
def cnn_model(input_shape=(28,28,1)):       # must keep the COLOR CHANNEL for conv
    model = Sequential()
...
if __name__ == "__main__":
    ...
    # train
    filepath = "weights/lstm_weights_{epoch:02d}_acc_{acc:.3f}_val_acc_{val_acc:.3f}.h5"
    filepath = "weights/cnn_weights_{epoch:02d}_acc_{acc:.3f}_val_acc_{val_acc:.3f}.h5"
